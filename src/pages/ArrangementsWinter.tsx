      ...
      <main className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Winter 2025</h1>
            <p className="text-lg text-muted-foreground">Embrace the magic of winter with our snow destinations</p>
          </div>
