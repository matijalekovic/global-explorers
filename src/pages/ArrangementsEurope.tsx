      ...
      <main className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">{t('arrangements.europe.title')}</h1>
            <p className="text-lg text-muted-foreground">{t('arrangements.europe.subtitle')}</p>
          </div>
